...
<span  style={{fontFamily:"NexaLight", position: 'absolute', top: '5%', left: '50%', transform: 'translateX(-50%)',zIndex:10,height:"80px",widt:'80px',color:"white" }}>
  Drag to view
    ...
    <span  style={{fontFamily:"NexaLight",fontSize:'8px', position: 'absolute', bottom: '2%', left: '50%', transform: 'translateX(-50%)',textAlign:'center',zIndex:10,width:'90%',color:"white" }}>
