...
export default function Home() {
  ...
  return (
    ...
    <section className="w-full h-screen flex   relative">
      <div className="fixed flex gap-4 flex-row items-center " style={{color:'white',width:"100%",height:'fit-content' ,top:0,zIndex:100,padding:"32px 16px 32px 16px"}}>
      <span>Look Around</span>
      <button onClick={handleOrbitControlsToggle} className="iconButton" >{orbitControlsActive?
      <svg
